...
$db = mysqli_connect($db_host, $db_username, $db_password,$db_name)
 ...
 $sql = "SELECT * FROM classea";
   ...
   if($resultat!=0)
   {
    ...
    echo" alert('قائمة أسماء قسم 1أ تمّ تعميرها مسبقا. هل تريد تغييرها')";
      echo      "</script>";
   }
   else
   {
    ...
    echo" alert('قائمة أسماء قسم 1أ فارغة')";
      echo      "</script>";
   }
...
<head>
    ...
    <title>التصرف في التلاميذ</title>
